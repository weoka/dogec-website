    ...
    <div class="block-a container" data-aos="fade-up">
        <div class="row">
            ...
            <div class="col-12 col-md-8 text-center">
                ...
                <p class="mt-5">We are actively developing an ecosystem of applications and platforms that will be mainly powered by DogeCash™. We are excited to partner with many other major cryptocurrencies. Our main focus? To provide charitable contributions and better the organizations selected with coinciding goals in mind. We look forward to the future with our new associates.</p>
            </div>
            <div class="col-md-2">&nbsp;</div>
        </div>
    </div>
